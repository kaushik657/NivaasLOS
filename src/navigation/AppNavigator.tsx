...
export default function AppNavigator() {
  return (
    <Stack.Navigator screenOptions={{
      ...
      <Stack.Screen name={ScreenNames.DOC_UPLOAAD} component={DocUploadScreen} />
      <Stack.Screen name={ScreenNames.FACE_LIVENESS} component={FaceLivenessScreen} />
      <Stack.Screen name={ScreenNames.LIVELINESS_RESULT} component={LivelinessResult} />
      <Stack.Screen name={ScreenNames.FACE_MATCH} component={FaceMatchScreen} />
      <Stack.Screen name={ScreenNames.FACE_MATCH_RESULT} component={FaceMatchResult} />
    </Stack.Navigator>
  );
}